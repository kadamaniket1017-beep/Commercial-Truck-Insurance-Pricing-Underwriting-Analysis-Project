...
with st.sidebar:
    ...
    st.link_button(
        ...
        url="https://commercial-truck-insurance-pricing-underwriting-analysis-t5-adv.streamlit.app/",
        type="primary",
        use_container_width=True
    )

    st.markdown(
        "⚠️ **Note:** It is strongly advised to free tier Gemini API Key Users for not use Advanced Version "
