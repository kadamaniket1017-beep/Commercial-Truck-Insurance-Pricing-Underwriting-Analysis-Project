...
with st.sidebar:
    ...
    st.caption("Key is already entered above in Section 3.")
...
st.caption(
        ...
        "**Reason-** In this advance version each Agent get there on thinking ability to transfer/calculate the output. "
